...
//     string background_output_path = "Output_Video/background_output.mp4";
//     string background_output_image_path = "Output_Video/final_background.png";
//
//     // Open input video
//     VideoCapture cap;
...
//                                 false);  // true: BGR
//
//     VideoWriter background_writer(background_output_path,
//                                    VideoWriter::fourcc('m', 'p', '4', 'v'),
//                                    fps,
//                                    Size(width, height),
//                                    true);  // true: BGR
...
//         // Manual conversion of background_u8 to BGR (without cvtColor)
//         Mat background_bgr(background_u8.size(), CV_8UC3);  // 3 channels (BGR)
//         for (int i = 0; i < background_u8.rows; ++i) {
//             for (int j = 0; j < background_u8.cols; ++j) {
//                 uchar gray_value = background_u8.at<uchar>(i, j);
//                 // Set all 3 channels to the same value
//                 background_bgr.at<Vec3b>(i, j) = Vec3b(gray_value, gray_value, gray_value);
//             }
//         }
//
//         // Save background frame (converted to BGR)
//         background_writer.write(background_bgr);
//
...
//     imwrite(background_output_image_path, final_background);
...
//     cout << "Background video saved: " << background_output_path << endl;
//     cout << "Background Photo saved: " << background_output_image_path << endl;
//
